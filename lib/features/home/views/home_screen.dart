          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                buildSection(key: _aboutUsKey, widget: const AboutUsSection(), height:isTablet?700: isMobile?900:800, color:  AppColors.whiteColor),
                buildSection(key: _ourServicesKey, widget: const OurServicesSection(), height:isMobile? 2250:1820, color:  AppColors.whiteColor),
                buildSection(key: _productionKey, widget: const ProductionSection(), height: 1830, color: AppColors.whiteColor),
                buildSection(key: _softwareKey, widget: const SoftwareSection(), height:isMobile?520:isTablet?900:900, color:  AppColors.whiteColor),
                buildSection(key: _consultationKey, widget:const ConsultationSection(), height:isMobile? 1910:isTablet?1000 :2050, color:  AppColors.whiteColor),
