...
class CustomCurvedRight extends StatelessWidget {
  const CustomCurvedRight({super.key, required this.fontSize, required this.text, required this.content, required this.url, required this.number, required this.image});
