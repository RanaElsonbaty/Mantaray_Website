                  ...
                  children: [
                    ...
                    Expanded(
                        child: ListView.separated(
                          ...
                          scrollDirection: Axis.horizontal,
                          itemBuilder: (context, index) {
                            return ProductBottomWidget(index: index, titleFontSize: getResponsiveFontSize(18).sp, containerHeight: 750, containerWidth: 550, imageHeight:350, imageWidth: 550, descriptionFontSize: 36, moreFontSize: 36, showSize: 32,);
                          }, separatorBuilder: (BuildContext context, int index) {
                          return SizedBox(width: 12.w,);
                        },
                        )
